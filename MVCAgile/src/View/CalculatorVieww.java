 ...
 */
public class CalculatorVieww extends javax.swing.JFrame {
 ...
 double result;
  String Operations;  
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        ...
        jtxtDisplay.getText(answer);
        
    
    }
    else if (operations == "");   
        result = firstNumber - secondNumber;
        answerr = String.format(%.of, result);
        jtxtDisplay.getText(answer);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculatorVieww.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculatorVieww().setVisible(true);
            }
        });
    }
